...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size( 'fifty', 450, 301, true ); //(two landscape images)
	add_image_size( 'fiftyV', 350, 526, true ); //(vertical portrait)
...
function hackeryou_continue_reading_link() {
	return ' <a class="readMore" href="'. get_permalink() . '">Read More <span class="meta-nav">&rarr;</span></a>';
}
